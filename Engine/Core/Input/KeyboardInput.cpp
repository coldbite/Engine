...
namespace Engine {
    namespace Input {
        ...
        void KeyboardInput::BindKey(KEY key, KeyCallback callback) {
            BindKey(key, KeyAction::PRESS, callback);
        }
        
        void KeyboardInput::BindKey(KEY key, KeyAction action, KeyCallback callback) {
            KeyBinding binding;
        ...
        void KeyboardInput::UnbindKey(KEY key) {
            keyBindings.erase(key);
        }
        
        void KeyboardInput::UnbindKey(KEY key, KeyAction action) {
        ...
        void KeyboardInput::OnKeyEvent(int platformKey, int platformAction) {
        ...
        void KeyboardInput::ClearBindings() {
            keyBindings.clear();
        }
        
        KEY KeyboardInput::ConvertPlatformKey(int platformKey) const {
#ifdef _WIN32
        ...
        KeyAction KeyboardInput::ConvertPlatformAction(int platformAction) const {
#ifdef _WIN32
